    ...
    <div className="pt-20 min-h-screen bg-white dark:bg-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid gap-16">
          {/* What is ITOBOT */}
          <section>
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">What is ITOBOT?</h2>
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-lg text-gray-600 dark:text-gray-300">
                ITOBOT is a FIRST Robotics Competition team based in Istanbul, Turkey. We are a group of high school students of Istanbul Chamber of Commerce Vocational and Technical Anatolian High School 
                who are passionate about robotics, engineering, and innovation. We design, build, and program robots to compete
                in FIRST Robotics Competition events.
              </p>
            </div>
          </section>
